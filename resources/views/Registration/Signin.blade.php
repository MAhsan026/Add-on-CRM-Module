        ...
        <div class="relative py-3 sm:max-w-xl sm:mx-auto">
            ...
            <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                ...
                <div class="max-w-md mx-auto">
                    ...
                    @if (session('success'))
                    <div class="p-4  my-2 rounded-md bg-green-400">
                        {{ session('success') }}
                    </div>
                    @endif
                    @if (session('error'))
                    <div class="p-4 my-2 rounded-md bg-red-400">
                        {{ session('error') }}
                    </div>
                    @endif
                ...
                <a href="{{ route('signup') }}"
                    class="font-medium text-blue-300 hover:text-blue-200 focus:outline-none focus:underline transition ease-in-out duration-150">
                    create new account
                </a>
